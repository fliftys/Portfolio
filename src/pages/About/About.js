          ...
          <div className="about__content">
            <div className="about__technologies">
              ...
              <p className="about__secondaryDescription">
                Podczas pracy dużą uwagę przywiązuję do jakości kodu który
                piszę. Biorę pod uwagę standardy, semantykę i optymalizacje.
                Aplikacje, które tworzę są dostosowane do wszystkich urządzeń.
                Staram się zachowywać dobre praktyki oraz korzystam z takich
                rozwiązań jak BEM, preprocesorów CSS czy kompilatorów do
                starszych wersji JS. Poniżej wymieniłem technologie z których
                korzystam na codzień i w których ciągle się doskonalę.
              </p>
            </div>
